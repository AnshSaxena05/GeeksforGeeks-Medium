...
public class gfg_Reach_a_given_score {
    ...
    public static void main(String[] args) {
        gfg_Reach_a_given_score solution = new gfg_Reach_a_given_score();

        // Test with a specific value of n
        int n = 10;
        long result = solution.count(n);
        System.out.println("Number of ways to reach the score " + n + " is: " + result);
    }
}
